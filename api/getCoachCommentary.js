...
const COACH_LINES = [
  ...
  },
  {
    ...
    weight: 7,
    ref: "Le Parrain",
    title: "Offre refusée impossible.",
  ...
  },
  {
    ...
    description: "{nbMulligan} cartes changées, donc non, pas vraiment. Le deck cherchait une bonne situation, il a surtout trouvé une mauvaise curve.",
    sourceLine: "Réf. comédie française : Astérix & Obélix : Mission Cléopâtre."
  },
  {
    buckets: ["mulligan"],
